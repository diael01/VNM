...
{
    /// <inheritdoc />
    public partial class AddAddressAndInverterInfo : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InverterType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BatteryType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NumberOfSolarPanels = table.Column<int>(type: "int", nullable: false),
                    SolarPanelType = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Addresses_InverterInfos_InverterInfoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Addresses_InverterInfoId",
                table: "Addresses",
