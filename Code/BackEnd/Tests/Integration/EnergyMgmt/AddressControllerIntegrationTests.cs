...
{
    public AddressControllerIntegrationTests() : base(new CustomWebApplicationFactory()) {}

    [Fact]
    public async Task AddressController_CRUD_Works()
    {
        ...
        Assert.Equal("CityC", fetched!.City);

        // Update
        fetched.City = "UpdatedCity";
