...
public class InverterController : ControllerBase
{
    ...
    public ActionResult<InverterData> GetData()
    {
        var data = new InverterData(
            PowerW: _rand.Next(_options.MinPower, _options.MaxPower + 1),
            VoltageV: _rand.Next(_options.MinVoltage, _options.MaxVoltage + 1),
            CurrentA: _rand.Next(_options.MinCurrent, _options.MaxCurrent + 1),
